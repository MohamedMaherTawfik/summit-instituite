...
@section('content')
                ...
                <form action="{{ route('attendances.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="date" class="form-control" required placeholder="أدخل اسم الطالب"
                                value="{{ now()->format('Y-m-d') }}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">حالة الحضور</label>
                            {{-- select inpu between حاضر غائب --}}
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const students = @json($students); // جلب الطلاب من الcontroller
